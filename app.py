...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thị Khánh - Trường Tiểu học Kim Đồng - ĐT: 097 7380955</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Thị Khánh - Trường Tiểu học Kim Đồng - ĐT: 097 7380955</div>", unsafe_allow_html=True)
